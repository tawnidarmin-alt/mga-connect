...
app.use(cors());
// This line ensures Render finds your HTML files in the main folder
app.use(express.static(path.join(__dirname)));

// --- 2. THE LINKS (THE FIX FOR "CANNOT GET") ---
app.get('/', (req, res) => {
...
app.post("/notify-client/:id", async (req, res) => {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: [b.email], // This will work if you put your email in the form
